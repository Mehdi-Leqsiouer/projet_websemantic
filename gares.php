        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="velib.php">Velib</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="gares.php"><b>Gares</b></a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <form role = "form" name ="distance" id = "distance" autocomplete="off" method = "GET" >
                    <div class="row">
                        ...
                        <div class="form-group">
                                <input type="text" name="nom_dep" id="nom_dep" placeholder = "Nom du département" disabled>
                            </div>
                        </div>
                        <div class="form-check">
                            ...
                            <div class="col-lg-6">
                        <div class="form-group">
                        <input type="number" name="num_dep" id="num_dep" placeholder = "Numéro du département" disabled>
                        </div>
                            </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="choice" id="region" >
                            <label class="form-check-label" for="flexRadioDefault2">
                                Afficher les gares dans la région:
                            </label>
                        </div>
                        <div class="col-lg-6">
                        <div class="form-group">
                        <input  type="text" name="region_in" id="region_in" placeholder = "Nom de la région" disabled>
                        </div>
                        </div>
                        <div class="col-12">
